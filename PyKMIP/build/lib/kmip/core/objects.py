...
class VendorAttribute(Struct):
    ...
    class AttributeValueInteger(Integer):
        def __init__(self, value=None):
            super(VendorAttribute.AttributeValueInteger, self).__init__(
                value, Tags.ATTRIBUTE_VALUE)

    class AttributeValueBytesString(ByteString):
        def __init__(self, value=None):
            super(VendorAttribute.AttributeValueBytesString, self).__init__(
                value, Tags.ATTRIBUTE_VALUE)
    ...
    def __init__(self,
        ...
        if isinstance(attribute_value, int):
            self.attribute_value = VendorAttribute.AttributeValueInteger(attribute_value)
        elif isinstance(attribute_value, bytes):
            self.attribute_value = VendorAttribute.AttributeValueBytesString(attribute_value)
        else:
            raise Exception("No attribute value type for {}".type(attribute_value))
...
class Link(Struct):
    ...
    class LinkedObjectIdentifier(TextString):
        def __init__(self, value=None):
            super(Link.LinkedObjectIdentifier, self).__init__(value, Tags.LINKED_OBJECT_IDENTIFIER)

    def __init__(self, link_type=None, link_object_identifier=None):
        super(Link, self).__init__(tag=Tags.LINK)
        self.link_type = Link.LinkType(link_type)
        self.linked_object_identifier = Link.LinkedObjectIdentifier(link_object_identifier)
    ...
    def write(self, ostream, kmip_version=enums.KMIPVersion.KMIP_2_0):
        ...
        self.linked_object_identifier.write(tstream, kmip_version=kmip_version)
